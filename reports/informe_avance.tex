...
Las cajas envolventes indicadas en la guía se utilizan para limitar la consulta. Para excluir el terreno circundante se incorporaron provisionalmente los contornos de las relaciones 5781818 y 11018382 de OpenStreetMap. Antes de calcular superficies definitivas deberán sustituirse por los polígonos GeoJSON oficiales mencionados por el curso.
...
Se descargaron y auditaron las 22 observaciones oficiales: once por lago, todas con tres bandas derivadas, proyección UTM 15N y resolución de 20 m. Los índices normalizados permanecieron en sus intervalos esperados. La cobertura válida estimada sobre el polígono provisional varió entre 77.7\% y 97.5\% en Amatitlán, y entre 43.2\% y 98.4\% en Atitlán. La imagen de Atitlán del 18 de enero de 2025 requiere especial cautela por su cobertura parcial.
...
Se completaron la estructura versionable, las 22 descargas, el control de calidad inicial, las estadísticas temporales y mapas comparativos preliminares. Falta sustituir los contornos por los oficiales del curso, revisar manualmente todas las fechas, efectuar correlaciones, análisis de persistencia y comparación ambiental, y validar la robustez del modelo ante valores extremos.
