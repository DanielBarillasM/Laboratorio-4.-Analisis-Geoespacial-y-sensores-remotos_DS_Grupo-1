...
Los 22 GeoTIFF derivados no se incluyen en el repositorio ni en el ZIP para evitar duplicar productos reproducibles de gran tamaño. Se conservan las fechas, geometrías, código y resultados derivados; \texttt{data/README.md} documenta la estructura esperada y los comandos exactos para descargarlos nuevamente desde CDSE y reconstruir todas las salidas.
